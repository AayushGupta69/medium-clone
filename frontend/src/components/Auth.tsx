...
export const Auth = ({ type }: { type: "signup" | "signin" }) => {
  ...
  async function sendRequest() {
    try {
      ...
      alert(`Error occured while ${type}`);
      console.log(error);
    }
  }
    ...
    <div className="h-screen flex justify-center flex-col">
      <div className="flex justify-center">
        <div>
          ...
          <div className="pt-8">
            {type === "signup" ? <LabelledInput label="Name" placeholder="Aayush Gupta..." onChange={(e) => {
              setPostInputs({
                ...postInputs,
                name: e.target.value
              })
            }} /> : null}
            <LabelledInput label="Username" placeholder="aayushgupta@gmail.com" onChange={(e) => {
              setPostInputs({
                ...postInputs,
